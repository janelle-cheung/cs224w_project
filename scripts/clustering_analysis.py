...
from config import DATA_DIR, LOGS_DIR, RESULTS_DIR, SLEEP_STAGES

LABELS_DIR = DATA_DIR / 'sleep_stage_labels'
...
def main():
    ...
    log_file = LOGS_DIR / f'clustering_bic_{output_name}.txt'
    ...
    # Create average and individual BIC curve plots
...
def plot_bic_curve(k_values: list, avg_metrics: dict, elbows: list, output_name: str):
    ...
    plt.tight_layout()
    plot_file = RESULTS_DIR / f'bic_avg_{output_name}.png'
...
def plot_individual_bic_curves(all_results: dict, output_name: str):
    ...
    plot_file = RESULTS_DIR / f'bic_all_{output_name}.png'
